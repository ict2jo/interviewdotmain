...
function PageContent() {
  ...
  const COLORS = ['#0e7490', '#083344', '#7dd3fc', '#075985', '#0891b2', '#a8a29e'];
              ...
              <div>
                <Paper elevation={3} style={{ padding: 16 }}>
                  ...
                  <div className='flex items-center ml-5 gap-3 mt-8 max-w-lg'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="text-red-500 h-6 w-6">
                  ...
                  <div className='flex items-center ml-5 gap-3 mt-8'>
                    ...
                    <p className='text-sm text-primary-800'>
                      각각의 파이 차트를 클릭하면 상세 내용을 확인할 수 있습니다.
                    </p>
                  </div>
                    ...
                    {hoveredData && (
                      <div>
                        <Typography variant="h6" gutterBottom>
                          <div className='bg-gray-200'>{hoveredData.유형} {hoveredData.이름}</div>
                        </Typography>
                        <Typography variant="body1">
                          <div className='grid grid-cols-3 gap-6'>
                            <ResultDetails title="흥미특성">{hoveredData.흥미특성}</ResultDetails>
                            <ResultDetails title="자기평가">{hoveredData.자기평가}</ResultDetails>
                            <ResultDetails title="타인평가">{hoveredData.타인평가}</ResultDetails>
                            <ResultDetails title="선호활동">{hoveredData.선호활동}</ResultDetails>
                            <ResultDetails title="적성">{hoveredData.적성}</ResultDetails>
                            <ResultDetails title="성격">{hoveredData.성격}</ResultDetails>
